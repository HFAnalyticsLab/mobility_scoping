...
## Net migration by age (London) {.tabset .tabset-dropdown}
...
## Mean age (England)  {.tabset .tabset-dropdown} 
...
## Mean age (London)  {.tabset .tabset-dropdown} 
...
## Net Migration and MSOA IMD (England)  {.tabset .tabset-dropdown} 
...
## Churn index for England (LSOA level) {.tabset .tabset-dropdown}
...
## Churn index for London only (LSOA level) {.tabset .tabset-dropdown}
