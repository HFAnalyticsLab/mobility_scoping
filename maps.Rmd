...
## Net migration by Economic Activity (England) {.tabset}

### Economically Active
```{r echo=FALSE}
img1_path <- here::here('outputs', "map13_2.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
...
```{r echo=FALSE}
img1_path <- here::here('outputs', "map13_1.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
...
## Net migration by Economic Activity (London) {.tabset}

### Economically Active
```{r echo=FALSE}
img1_path <- here::here('outputs', "map13_4.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
...
### Economically Inactive
```{r echo=FALSE}
img1_path <- here::here('outputs', "map13_3.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
...
## Net migration by Health Status (England & Wales) {.tabset}


### Limited a lot in daily activities
```{r echo=FALSE}
img1_path <- here::here('outputs', "map14_1.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
...
### Limited a little in daily activities
```{r echo=FALSE}
img1_path <- here::here('outputs', "map14_2.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
...
### Not limited in daily activities
```{r echo=FALSE}
img1_path <- here::here('outputs', "map14_3.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
...
## Net migration by Health Status (London) {.tabset}
### Limited a lot in daily activities
```{r echo=FALSE}
img1_path <- here::here('outputs', "map14_4.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
...
### Limited a little in daily activities
```{r echo=FALSE}
img1_path <- here::here('outputs', "map14_5.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
...
### Not limited in daily activities
```{r echo=FALSE}
img1_path <- here::here('outputs', "map14_6.png")
img1 <- readPNG(img1_path, native = TRUE, info = TRUE)
